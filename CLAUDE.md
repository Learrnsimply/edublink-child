...
**📖 ابدأ من دول — بالترتيب:**

0. **[`docs/CHANGELOG.md`](docs/CHANGELOG.md)** — كل اللي اتعمل ومتى. **اقرأه الأول** عشان تعرف إحنا فين.


1. **[`docs/CHECKOUT-AUDIT.md`](docs/CHECKOUT-AUDIT.md)** — قمع الشرا مكسور: 94.5% بيسيبوا السلة. قائمة الشغل مرتّبة بالعائد. **دي الأولوية الحالية.**
2. **[`docs/ACADEMY-PLAN.md`](docs/ACADEMY-PLAN.md)** — الخطة المتفق عليها: تحويل المنصة لأكاديمية بقسمين. المراحل والأدوات والقرارات المفتوحة. **ده الشغل الحالي.**
3. **[`docs/BUSINESS-CONTEXT.md`](docs/BUSINESS-CONTEXT.md)** — الكتالوج والأسعار والجمهور، والفجوة بين القناة والموقع، والأسئلة المفتوحة. **اقرأه الأول** — بيحدد ليه بنعمل اللي بنعمله.
4. **[`docs/DESIGN-SYSTEM.md`](docs/DESIGN-SYSTEM.md)** — حالة نظام التوكنز والخطوات التقنية.
5. **[`docs/inherited/README.md`](docs/inherited/README.md)** — أرشيف ورشة عمر: 137 باگ موثّق، تدقيقات، تحليل 2,936 أوردر، و**mu-plugins شغالة على السيرفر مش في الثيم**.
...
**أي تغيير على الموقع بيتكتب في [`docs/CHANGELOG.md`](docs/CHANGELOG.md) قبل الكوميت.**
مش بعده، ومش «لما نفضى». السطر الواحد في السجل بيوفّر إعادة اكتشاف بعد شهر.

الصيغة: **ليه** · **اللي اتعمل** · **النتيجة** · **الفرع**.

ولو التغيير كشف حاجة عن البيزنس أو الأرقام أو الكود — تتكتب كمان في الملف بتاعها
(`BUSINESS-CONTEXT.md` للأرقام، `DESIGN-SYSTEM.md` للتصميم، `CHECKOUT-AUDIT.md` للقمع).
